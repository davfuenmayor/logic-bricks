...
abbreviation(input) fmap0 :: "'b \<Rightarrow> ('r \<Rightarrow> 'r) \<Rightarrow> 'r-Cont('b)"
  where "fmap0 \<equiv> \<^bold>L (\<^bold>T \<circ>\<^sub>2 \<^bold>B\<^sub>0)"
abbreviation(input) fmap1::"('a \<Rightarrow> 'b) \<Rightarrow> 'r-Cont('a) \<Rightarrow> 'r-Cont('b)"
  where "fmap1 \<equiv> \<^bold>L (\<^bold>T \<circ>\<^sub>2 \<^bold>B\<^sub>1)"
abbreviation(input) fmap2::"('a \<Rightarrow> 'b \<Rightarrow> 'c) \<Rightarrow> 'r-Cont\<^sub>2('a,'b) \<Rightarrow> 'r-Cont('c)"
  where "fmap2 \<equiv> \<^bold>L (\<^bold>T \<circ>\<^sub>2 \<^bold>B\<^sub>2)"
abbreviation(input) fmap3::"('a \<Rightarrow> 'b \<Rightarrow> 'c \<Rightarrow> 'd) \<Rightarrow> 'r-Cont\<^sub>3('a,'b,'c) \<Rightarrow> 'r-Cont('d)"
  where "fmap3 \<equiv> \<^bold>L (\<^bold>T \<circ>\<^sub>2 \<^bold>B\<^sub>3)"
abbreviation(input) fmap4::"('a \<Rightarrow> 'b \<Rightarrow> 'c \<Rightarrow> 'd \<Rightarrow> 'e) \<Rightarrow> 'r-Cont\<^sub>4('a,'b,'c,'d) \<Rightarrow> 'r-Cont('e)"
...
abbreviation(input) unit::"'a \<Rightarrow> 'r-Cont('a)"
...
abbreviation(input) ap0::"'r-Cont('b) \<Rightarrow> ('r \<Rightarrow> 'r) \<Rightarrow> 'r-Cont('b)"
  where "ap0 \<equiv> ((\<^bold>C\<^bold>B\<^sub>2) \<circ> (\<^bold>C\<^bold>B\<^sub>2)) \<^bold>B\<^sub>0"
abbreviation(input) ap1::"'r-Cont('a \<Rightarrow> 'b) \<Rightarrow> 'r-Cont('a) \<Rightarrow> 'r-Cont('b)"
  where "ap1 \<equiv> ((\<^bold>C\<^bold>B\<^sub>2) \<circ> (\<^bold>C\<^bold>B\<^sub>2)) \<^bold>B\<^sub>1"
abbreviation(input) ap2::"'r-Cont('a \<Rightarrow> 'b \<Rightarrow> 'c) \<Rightarrow> 'r-Cont\<^sub>2('a,'b) \<Rightarrow> 'r-Cont('c)"
  where "ap2 \<equiv> ((\<^bold>C\<^bold>B\<^sub>2) \<circ> (\<^bold>C\<^bold>B\<^sub>2)) \<^bold>B\<^sub>2"
abbreviation(input) ap3::"'r-Cont('a \<Rightarrow> 'b \<Rightarrow> 'c \<Rightarrow> 'd) \<Rightarrow> 'r-Cont\<^sub>3('a,'b,'c) \<Rightarrow> 'r-Cont('d)"
...
abbreviation(input) apr :: "'r-Cont('a) \<Rightarrow> 'r-Cont('a \<Rightarrow> 'b) \<Rightarrow> 'r-Cont('b)"(infixl "\<ggreater>" 54)
  where "a \<ggreater> f \<equiv> ap f a"  \<comment> \<open>convenient "pipeline notation"\<close>


subsection \<open>Monad\<close>

abbreviation bindr1::"('a \<Rightarrow> 'r-Cont('b)) \<Rightarrow> 'r-Cont('a) \<Rightarrow> 'r-Cont('b)"
  where "bindr1 \<equiv> \<^bold>D\<^bold>C\<^bold>B \<^bold>C"
abbreviation bindr2::"('a \<Rightarrow> 'b \<Rightarrow> 'r-Cont('c)) \<Rightarrow> 'r-Cont\<^sub>2('a,'b) \<Rightarrow> 'r-Cont('c)"
  where "bindr2 \<equiv> \<^bold>D\<^bold>C\<^bold>B \<^bold>C\<^sub>2\<^sub>3\<^sub>1"
abbreviation bindr3::"('a \<Rightarrow> 'b \<Rightarrow> 'c \<Rightarrow> 'r-Cont('d)) \<Rightarrow> 'r-Cont\<^sub>3('a,'b,'c) \<Rightarrow> 'r-Cont('d)"
...
abbreviation(input) bind::"'r-Cont('a) \<Rightarrow> ('a \<Rightarrow> 'r-Cont('b)) \<Rightarrow> 'r-Cont('b)" (infixl "\<bind>" 54)
...
abbreviation join::"'r-Cont('r-Cont('a)) \<Rightarrow> 'r-Cont('a)"
