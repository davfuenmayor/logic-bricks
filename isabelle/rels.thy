...
lemma "one_to_one \<subseteq> singletonR" nitpick oops \<comment> \<open>counterexample: e.g. empty relation\<close>
...
lemma "asRel (asFun R) = R" nitpick oops \<comment> \<open>counterexample\<close>
...
lemma "leftTotal R \<Longrightarrow> R \<subseteq>\<^sup>r asRel (asFun R)" nitpick oops \<comment> \<open>counterexample\<close>
...
lemma "rightUnique R \<Longrightarrow> asRel (asFun R) \<subseteq>\<^sup>r R" nitpick oops \<comment> \<open>counterexample\<close>
...
lemma "intoFunSet (intoRel S) \<subseteq> S" nitpick oops \<comment> \<open>counterexample\<close>
...
lemma "R \<subseteq>\<^sup>r intoRel (intoFunSet R)" nitpick oops \<comment> \<open>counterexample\<close>
...
lemma "R-rightBound(\<Inter>S) = \<Union>\<lparr>R-rightBound S\<rparr>" nitpick oops \<comment> \<open>counterexample\<close>
lemma  "R-leftBound(\<Inter>S) = \<Union>\<lparr>R-leftBound S\<rparr>" nitpick oops  \<comment> \<open>counterexample\<close>
